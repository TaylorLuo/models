...
# locally run path
output_dir=/home/taylor/Documents/homework/week08/quiz-w8-data/output  # 训练目录
dataset_dir=/home/taylor/Documents/homework/week08/quiz-w8-data # 数据集目录，这里是写死的，记得修改
...
python ./inference.py --output_dir=/home/taylor/Documents/homework/week08/quiz-w8-data/output --dataset_dir=/home/taylor/Documents/homework/week08/quiz-w8-data
